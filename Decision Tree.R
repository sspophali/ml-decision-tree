...
#########
ranTree=randomForest(Kyphosis~.,data=train,nTrees=100)
...
tree.predict$Kyphosis_State <- sapply(tree.predict$present,joiner)
tree.predict

table(tree.predict$Kyphosis_State,test$Kyphosis)
